...
- **Ícone de marca:** manter o emoji já usado como logo (ex.: 🥖) em vez de introduzir um arquivo de imagem/ícone — zero asset novo, consistente com rodar sem pipeline de build (ADR-003).
